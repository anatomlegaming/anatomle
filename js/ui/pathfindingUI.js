...
(function() {
    ...
    var C = {
        ...
        golden:     '#f0a500',
        sage:       '#5a8a6a',
        sageDim:    'rgba(90,138,106,0.12)',
        sageBorder: 'rgba(90,138,106,0.35)',
        reveal:     '#8b5cf6',
    };

    var PANEL_W = 300, NAV_H = 58, BAR_H = 46, SRCH_H = 68;

    function secHead(icon, label, count, color) {
        return e('div', {
            style: { padding:'10px 14px 8px', display:'flex', justifyContent:'space-between',
    ...
    function PathfindingUI(props) {
        ...
        var navbar = e('div', {
            style: { position:'fixed', top:0, left:0, right:0, height:NAV_H, zIndex:300,
                ...
                padding:'0 20px', boxShadow:'0 2px 16px rgba(45,31,20,0.07)' }
        },
            e('div', { style: { display:'flex', alignItems:'baseline', gap:0 } },
                ...
                e('span', { style: { fontFamily:'DM Sans, sans-serif', fontSize:9, color:C.muted,
                    textTransform:'uppercase', letterSpacing:'0.2em', marginLeft:10,
                    alignSelf:'center', paddingBottom:1 } }, gameTitle)
            ),
            e('div', { style: { display:'flex', alignItems:'center', gap:14 } },
                e('div', { style: { textAlign:'right' } },
                    e('div', { style: { fontFamily:'Fraunces, serif', fontWeight:900, fontSize:22,
                        color: dangerZone ? C.coralDark : C.ink, lineHeight:1,
                        transition:'color 0.3s' } }, left),
                    e('div', { style: { fontFamily:'DM Sans, sans-serif', fontSize:8,
                        color:C.muted, textTransform:'uppercase', letterSpacing:'0.15em' } }, 'guesses left')
                ),
                e('a', {
                    href:'../index.html',
        ...
        var challengeBar = e('div', {
            style: { position:'fixed', top:NAV_H, left:0, right:PANEL_W, height:BAR_H, zIndex:200,
                background:'rgba(45,31,20,0.94)', backdropFilter:'blur(6px)',
                display:'flex', alignItems:'center', justifyContent:'space-between',
                padding:'0 20px' }
        },
            e('div', { style: { display:'flex', alignItems:'center', gap:8 } },
                e('span', { style: { fontFamily:'DM Sans, sans-serif', fontSize:9,
                    ...
                    letterSpacing:'0.2em', marginRight:4 } }, 'Route'),
                e('span', { style: { fontFamily:'Fraunces, serif', fontWeight:700,
                    fontSize:14, color:'#a8d5b5', fontStyle:'italic' } }, target.start || '\u2026'),
                e('span', { style: { fontFamily:'DM Sans, sans-serif', color:'rgba(253,246,236,0.25)',
            ...
            e('div', { style: { display:'flex', alignItems:'center', gap:10 } },
                e('span', { style: { fontFamily:'DM Sans, sans-serif', fontSize:9,
                    ...
                    guessedCount + ' / ' + pathLen + ' bones'),
                e('div', { style: { width:72, height:4, background:'rgba(255,255,255,0.1)',
        ...
        var chainItems = chain.map(function(item, idx) {
            ...
            if (isStart) {
                bg = C.sageDim; bc = C.sageBorder; color = C.sage; icon = '\uD83D\uDCCD';
            } else if (isLast) {
        ...
        var rightPanel = e('div', {
            style: { position:'fixed', top:NAV_H, right:0, width:PANEL_W, bottom:0, zIndex:200,
                background:C.panelBg || C.cream,
                borderLeft:'2px solid ' + C.border, display:'flex', flexDirection:'column',
            ...
            e('div', { style: { flex:'1 1 0', overflow:'hidden', display:'flex',
                ...
                e('div', { className:'scr', style: { overflowY:'auto', flex:1, padding:'10px 12px' } }, chainItems)
            ),
            e('div', { style: { flex:'0 0 auto', maxHeight:'26%', overflow:'hidden', display:'flex',
                flexDirection:'column', borderBottom:'2px solid ' + C.border } },
                secHead('\u26A0', 'Detours', detours.length, C.golden),
                e('div', { className:'scr', style: { overflowY:'auto', flex:1, padding:'8px 12px' } }, detourItems)
            ),
            e('div', { style: { flex:'0 0 auto', maxHeight:'22%', overflow:'hidden', display:'flex',
                flexDirection:'column', borderBottom:'2px solid ' + C.border } },
                secHead('\u2717', 'Wrong', bad.length, C.coralDark),
                e('div', { className:'scr', style: { overflowY:'auto', flex:1, padding:'8px 12px' } }, badItems)
            ),
        ...
        var searchBar = e('div', {
            style: { position:'fixed', bottom:0, left:0, right:PANEL_W, height:SRCH_H, zIndex:250,
                background:C.cream, borderTop:'2px solid ' + C.border,
            ...
            e('div', { style: { flex:1, position:'relative' } },
                ...
                e('div', { style: { position:'relative' } },
                    ...
                    e('input', {
                        ...
                        style: { width:'100%', background: phase !== 'playing' ? 'rgba(45,31,20,0.04)' : C.cardBg,
        ...
        var overlay = (phase !== 'playing' && !reveal)
            ? e('div', {
                style: { position:'fixed', inset:0, zIndex:600, display:'flex',
